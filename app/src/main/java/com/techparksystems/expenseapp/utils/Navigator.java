package com.techparksystems.expenseapp.utils;
...
import com.techparksystems.expenseapp.R;
...
public class Navigator {
    ...
    public static void goToActivityBackwardFinish(Context context,final Class<? extends Activity> targetActivity) {
        Intent loginIntent = new Intent(context, targetActivity);
        loginIntent.setFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
        context.startActivity(loginIntent);
        ((Activity) context).finish();
...
//        transaction.addToBackStack(null);
    ...
    public static void fragmentChildForwardNoBackStack(Context context, int frameId, Fragment fragment, boolean setTransition) {
        FragmentTransaction transaction = ((AppCompatActivity) context).getSupportFragmentManager().beginTransaction();
        if (setTransition) {
            transaction.setCustomAnimations(R.anim.anim_fade_in, R.anim.anim_fade_out, R.anim.anim_fade_in, R.anim.anim_fade_out);
        }
